...
class _DetailScreenState extends State<DetailScreen> {
              ...
              children: <Widget>[
                Text("Price".toUpperCase(),
                    style: TextStyle(
                        ...
                        color: Color(0xFF565656))),
                Text(
                    "Ksh ${(widget.productDetails!.data!.productVariants![0].maxPrice != null) ? widget.productDetails!.data!.productVariants![0].maxPrice : "Unavailable"}"
                        .toUpperCase(),
                    style: TextStyle(
  ...
  List<Widget> generateProductSpecification(BuildContext context) {
    List<Widget> list = [];
    int count = 0;
    widget.productDetails!.data!.productSpecifications!
